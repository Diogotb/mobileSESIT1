...
class _Exemplo2PageState extends State<Exemplo2Page> {
  ...
  void _loadPreferences() async{
    _prefs = await SharedPreferences.getInstance();//pega as informaç~eos salvas no Shared
    setState(() {
  ...
  void savePreferences() async{
    ...
    await _prefs.setBool("darkMode", _darkMode); // atribuindo a valor  da variável _darkMode a chave darkmode do Shared
  }
